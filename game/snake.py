...
class Snake:
    ...
    def detect_wall_collision(self, game_field):
        """
        ...
        if self.direction == Direction.LEFT:
            ...
            return self.x + game_field.grid_size > game_field.width
        elif self.direction == Direction.DOWN:
            return self.y + game_field.grid_size > game_field.height
        elif self.direction == Direction.UP:
            return self.y < 0

    def detect_food_collision(self, apple, grid_size):
        """
        ...
        apple_rect = pygame.Rect(apple.x, apple.y, grid_size, grid_size)
        return head_rect.colliderect(apple_rect)

    def detect_self_collision(self, grid_size):
    ...
    def detect_enemy_collision(self, enemy_snake, grid_size):
        """
        ...
        enemy_head_rect = pygame.Rect(enemy_snake.x, enemy_snake.y, grid_size, grid_size)
        head_rect = pygame.Rect(self.x, self.y, grid_size, grid_size)
    ...
    def draw(self, surface):
        ...
        surface.blit(self.head_images[self.direction], (self.x, self.y))
    ...
    def controlled_move(self, event, grid_size):
        """
        ...
        if self.direction == Direction.LEFT:
            self.x -= self.x - self.x // grid_size * grid_size
        elif self.direction == Direction.RIGHT:
            self.x = self.x // grid_size * grid_size + grid_size
        elif self.direction == Direction.DOWN:
            self.y = self.y // grid_size * grid_size + grid_size
        elif self.direction == Direction.UP:
            self.y -= self.y - self.y // grid_size * grid_size
    ...
    def move(self, grid_size):
        ...
        length_in_pixels = self.length * grid_size
        ...
        while i > 0 and length_in_pixels > 0:
            ...
            if to_direction == Direction.LEFT:
                ...
                body_rect = pygame.Rect(end_x, end_y, start_x - end_x, grid_size) if is_longer else pygame.Rect(start_x - length_in_pixels, start_y, length_in_pixels, grid_size)
                ...
                body_rect = pygame.Rect(start_x + grid_size, start_y, end_x - start_x, grid_size) if is_longer else pygame.Rect(start_x + grid_size, start_y, length_in_pixels, grid_size)
                length_in_pixels -= end_x - start_x
                self.body_rects.append(body_rect)
            elif to_direction == Direction.DOWN:
                is_longer = length_in_pixels > end_y - start_y
                body_rect = pygame.Rect(start_x, start_y + grid_size, grid_size, end_y - start_y) if is_longer else pygame.Rect(start_x, start_y + grid_size, grid_size, length_in_pixels)
                length_in_pixels -= end_y - start_y
                self.body_rects.append(body_rect)
            elif to_direction == Direction.UP:
                is_longer = length_in_pixels > start_y - end_y
                body_rect = pygame.Rect(end_x, end_y, grid_size, start_y - end_y) if is_longer else pygame.Rect(end_x, end_y - length_in_pixels + start_y - end_y, grid_size, length_in_pixels)
        ...
        if length_in_pixels > 0:
            ...
            to_direction = self.rotate_points[i].backward_direction
            if to_direction == Direction.LEFT:
                body_rect = pygame.Rect(start_x - length_in_pixels, start_y, length_in_pixels, grid_size)
            elif to_direction == Direction.RIGHT:
                body_rect = pygame.Rect(start_x + grid_size, start_y, length_in_pixels, grid_size)
            elif to_direction == Direction.DOWN:
                body_rect = pygame.Rect(start_x, start_y + grid_size, grid_size, length_in_pixels)
            elif to_direction == Direction.UP:
                body_rect = pygame.Rect(start_x, start_y - length_in_pixels, grid_size, length_in_pixels)
            self.body_rects.append(body_rect)
